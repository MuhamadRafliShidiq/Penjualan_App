...
<body>
    ...
    <table>
        ...
        <tbody>
            <?php $__currentLoopData = $penjualan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($p->faktur); ?></td>
                    <td><?php echo e($p->pelanggan->nama_pelanggan ?? '-'); ?></td>
                    <td style="text-align: center;">
                        <?php echo e(\Carbon\Carbon::parse($p->tanggal_penjualan)->format('d-m-Y')); ?>
    ...
    <div class="footer">
        <p>© <?php echo e(now()->year); ?> Sistem Penjualan — PT. Nama Perusahaan</p>
    </div>

</body>
</html>
<?php /**PATH C:\Users\RAFLI-20031908\Desktop\penjualan_barang\resources\views/penjualan/pdf.blade.php ENDPATH**/ ?>